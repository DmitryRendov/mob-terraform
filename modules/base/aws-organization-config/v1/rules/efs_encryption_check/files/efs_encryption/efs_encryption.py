...
# Forked from: https://github.com/awslabs/aws-config-rules/blob/master/python/EFS_ENCRYPTED_CHECK/EFS_ENCRYPTED_CHECK.py
#
# Trigger Type: Periodic
# Scope of Changes: AWS::EFS::FileSystem
